...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, title: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, name: string, bio: string } | null } | null };
